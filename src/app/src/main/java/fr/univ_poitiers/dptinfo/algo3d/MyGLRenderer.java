...
public class MyGLRenderer implements GLSurfaceView.Renderer
{
    ...
    static public final float[] glass={0.2F,0.2F,0.2F,0.25F};
     ...
     * Shaders
     */
    private BlinnPhongShaders shaders;
    /**
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config)
    {
        // Create shader
        try {
            this.shaders = new BlinnPhongShaders(view.getContext()); // or other shaders
            checkGlError("Shader Creation");
        }
        catch (Exception e)
        {
            MainActivity.log("Shader Error :" +e);
            throw e;
        }
